#!/usr/bin/env python3
"""
Helper script: print usage for EAPF 2025 question generation and merge.
Run with --help or -h for this message.
"""
import argparse

HELP_TEXT = """
EAPF 2025 – Question generation
...
Cursor-assisted (prompt + merge):
  python generate_questions_cursor.py wizard              # automated: prompt, open file, wait for new_questions.json, merge
...
def main():
    parser = argparse.ArgumentParser(
        description="EAPF 2025 practice test – question generation helper.",
